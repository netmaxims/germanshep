...
<div class="row">
    <div class="container mt-5 mb-5 col-md-6 col-md-offset-4">
        ...
        <form action="<?php echo e(route('signup.create')); ?>"  method="POST" class="form-container" >
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('include.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\germanshep\resources\views/register.blade.php ENDPATH**/ ?>