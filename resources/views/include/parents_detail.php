...
$mszdetail = "SELECT * from " . $config['tb_prefix'] . "pd_entries WHERE reg1='$msz'";
$mszresultdetail = mysqli_query($aVar, $mszdetail);
$mszccdetail = mysqli_fetch_assoc($mszresultdetail);

$mshowdetail = "Select * from " . $config['tb_prefix'] . "pd_show where sz = $msz AND cat != '' ORDER BY showid desc LIMIT 1";
$mshowresultdetail = mysqli_query($aVar, $mshowdetail);
$mshowccdetail = mysqli_fetch_assoc($mshowresultdetail);

$mkorkdetail = "Select * from " . $config['tb_prefix'] . "pd_kork where pd = '$msz'";
$mkorkresultdetail = mysqli_query($aVar, $mkorkdetail);
$mkorkcdetail = mysqli_fetch_assoc($mkorkresultdetail);

if ($mkorkcdetail['kork'] == 1) {
    $mkorkDetail = '/Kkl 1';
} else if ($mkorkcdetail['kork'] == 2) {
    $mkorkDetail = '/Kkl 2';
} else if ($mszccdetail['kork'] == 1) {
    $mkorkDetail = '/Kkl 1';
} else if ($mszccdetail['kork'] == 2) {
    $mkorkDetail = '/Kkl 2';
}
?>
...
$fszdetail = "SELECT * from " . $config['tb_prefix'] . "pd_entries WHERE reg1='$fsz'";
$fszresultdetail = mysqli_query($aVar, $fszdetail);
$fszccdetail = mysqli_fetch_assoc($fszresultdetail);

$fshowdetail = "Select * from " . $config['tb_prefix'] . "pd_show where sz = $fsz AND cat != '' ORDER BY showid desc LIMIT 1";
$fshowresultdetail = mysqli_query($aVar, $fshowdetail);
$fshowccdetail = mysqli_fetch_assoc($fshowresultdetail);

$fkorkdetail = "Select * from " . $config['tb_prefix'] . "pd_kork where pd = '$fsz'";
$fkorkresultdetail = mysqli_query($aVar, $fkorkdetail);
$fkorkcdetail = mysqli_fetch_assoc($fkorkresultdetail);

if ($fkorkcdetail['kork'] == 1) {
    $fkorkDetail = '/Kkl 1';
} else if ($fkorkcdetail['kork'] == 2) {
    $fkorkDetail = '/Kkl 2';
} else if ($fszccdetail['kork'] == 1) {
    $fkorkDetail = '/Kkl 1';
} else if ($fszccdetail['kork'] == 2) {
    $fkorkDetail = '/Kkl 2';
}
?>
...
<!-- Second Column -->
<?php
$fmsz = $fszccdetail["mother_id"];
$fmszdetail = "SELECT * from " . $config['tb_prefix'] . "pd_entries WHERE reg1='$fmsz'";
$fmszresultdetail = mysqli_query($aVar, $fmszdetail);
$fmszccdetail = mysqli_fetch_assoc($fmszresultdetail);

$fmshowdetail = "Select * from " . $config['tb_prefix'] . "pd_show where sz = $fmsz AND cat != '' ORDER BY showid desc LIMIT 1";
$fmshowresultdetail = mysqli_query($aVar, $fmshowdetail);
$fmshowccdetail = mysqli_fetch_assoc($fmshowresultdetail);


$fmszkorkdetail = "Select * from " . $config['tb_prefix'] . "pd_kork where pd = '$fmsz'";
$fmszkorkresultdetail = mysqli_query($aVar, $fmszkorkdetail);
$fmszkorkcdetail = mysqli_fetch_assoc($fmszkorkresultdetail);

if ($fmszkorkcdetail['kork'] == 1) {
    $fmszkorkDetail = '/Kkl 1';
} else if ($fmszkorkcdetail['kork'] == 2) {
    $fmszkorkDetail = '/Kkl 2';
} else if ($fmszccdetail['kork'] == 1) {
    $fmszkorkDetail = '/Kkl 1';
} else if ($fmszccdetail['kork'] == 2) {
    $fmszkorkDetail = '/Kkl 2';
}
...
<!-- For F.Father Detail  -->
<?php
$ffsz = $fszccdetail["father_id"];
$ffszdetail = "SELECT * from " . $config['tb_prefix'] . "pd_entries WHERE reg1='$ffsz'";
$ffszresultdetail = mysqli_query($aVar, $ffszdetail);
$ffszccdetail = mysqli_fetch_assoc($ffszresultdetail);


$ffshowdetail = "Select * from " . $config['tb_prefix'] . "pd_show where sz = $ffsz AND cat != '' ORDER BY showid desc LIMIT 1";
$ffshowresultdetail = mysqli_query($aVar, $ffshowdetail);
$ffshowccdetail = mysqli_fetch_assoc($ffshowresultdetail);


$ffszckorkdetail = "Select * from " . $config['tb_prefix'] . "pd_kork where pd = '$ffsz'";
$ffszckorkresultdetail = mysqli_query($aVar, $ffszckorkdetail);
$ffszckorkcdetail = mysqli_fetch_assoc($ffszckorkresultdetail);

if ($ffszckorkcdetail['kork'] == 1) {
    $ffszckorkDetail = '/Kkl 1';
} else if ($ffszckorkcdetail['kork'] == 2) {
    $ffszckorkDetail = '/Kkl 2';
} else if ($ffszccdetail['kork'] == 1) {
    $ffszckorkDetail = '/Kkl 1';
} else if ($fmszccdetail['kork'] == 2) {
    $ffszckorkDetail = '/Kkl 2';
}
...
<!-- For M.mother Detail  -->
<?php
$mmsz = $mszccdetail["mother_id"];
$mmszdetail = "SELECT * from " . $config['tb_prefix'] . "pd_entries WHERE reg1='$mmsz'";
$mmszresultdetail = mysqli_query($aVar, $mmszdetail);
$mmszccdetail = mysqli_fetch_assoc($mmszresultdetail);

$mmshowdetail = "Select * from " . $config['tb_prefix'] . "pd_show where sz = $mmsz AND cat != '' ORDER BY showid desc LIMIT 1";
$mmshowresultdetail = mysqli_query($aVar, $mmshowdetail);
$mmshowccdetail = mysqli_fetch_assoc($mmshowresultdetail);

$mmszckorkdetail = "Select * from " . $config['tb_prefix'] . "pd_kork where pd = '$mmsz'";
$mmszckorkresultdetail = mysqli_query($aVar, $mmszckorkdetail);
$mmszckorkcdetail = mysqli_fetch_assoc($mmszckorkresultdetail);

if ($mmszckorkcdetail['kork'] == 1) {
    $mmszckorkDetail = '/Kkl 1';
} else if ($mmszckorkcdetail['kork'] == 2) {
    $mmszckorkDetail = '/Kkl 2';
} else if ($mmszccdetail['kork'] == 1) {
    $mmszckorkDetail = '/Kkl 1';
} else if ($mmszccdetail['kork'] == 2) {
    $mmszckorkDetail = '/Kkl 2';
}
?>
...
<!-- For M.Father Detail  -->
<?php
$mfsz = $mszccdetail["father_id"];
$mfszdetail = "SELECT * from " . $config['tb_prefix'] . "pd_entries WHERE reg1='$mfsz'";
$mfszresultdetail = mysqli_query($aVar, $mfszdetail);
$mfszccdetail = mysqli_fetch_assoc($mfszresultdetail);

$mfshowdetail = "Select * from " . $config['tb_prefix'] . "pd_show where sz = $mfsz AND cat != '' ORDER BY showid desc LIMIT 1";
$mfshowresultdetail = mysqli_query($aVar, $mfshowdetail);
$mfshowccdetail = mysqli_fetch_assoc($mfshowresultdetail);

$mfszckorkdetail = "Select * from " . $config['tb_prefix'] . "pd_kork where pd = '$mfsz'";
$mfszckorkresultdetail = mysqli_query($aVar, $mfszckorkdetail);
$mfszckorkcdetail = mysqli_fetch_assoc($mfszckorkresultdetail);

if ($mfszckorkcdetail['kork'] == 1) {
    $mfszckorkDetail = '/Kkl 1';
} else if ($mfszckorkcdetail['kork'] == 2) {
    $mfszckorkDetail = '/Kkl 2';
} else if ($mfszccdetail['kork'] == 1) {
    $mfszckorkDetail = '/Kkl 2';
} else if ($mfszccdetail['kork'] == 2) {
    $mfszckorkDetail = '/Kkl 2';
}
?>
...
$mmmszdetail = "SELECT * from " . $config['tb_prefix'] . "pd_entries WHERE reg1='$mmmsz'";
$mmmszresultdetail = mysqli_query($aVar, $mmmszdetail);
$mmmszccdetail = mysqli_fetch_assoc($mmmszresultdetail);

$mmmszdetailshow = "Select * from " . config['tb_prefix'] . "pd_show where sz = $mmmsz AND cat != '' ORDER BY showid desc LIMIT 1";
...
$mmfszdetail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$mmfsz'";
$mmfszresultdetail = mysqli_query($aVar, $mmfszdetail);
$mmfszccdetail = mysqli_fetch_assoc($mmfszresultdetail);

$mmfszdetailshow = "Select * from " . config['tb_prefix'] . "pd_show where sz = $mmfsz AND cat != '' ORDER BY showid desc LIMIT 1";
...
$mmmmszdetail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$mfmsz'";
$mmmmszresultdetail = mysqli_query($aVar, $mmmmszdetail);
$mmmmszccdetail = mysqli_fetch_assoc($mmmmszresultdetail);

$mmmmszdetailshow = "Select * from " . config['tb_prefix'] . "pd_show where sz = $mfmsz AND cat != '' ORDER BY showid desc LIMIT 1";
...
$mffszdetail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$mffsz'";
$mffszresultdetail = mysqli_query($aVar, $mffszdetail);
$mffszccdetail = mysqli_fetch_assoc($mffszresultdetail);

$mffszdetailshow = "Select * from " . config['tb_prefix'] . "pd_show where sz = $mffsz AND cat != '' ORDER BY showid desc LIMIT 1";
...
$ffmszdetail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$ffmsz'";
$ffmszresultdetail = mysqli_query($aVar, $ffmszdetail);
$ffmszccdetail = mysqli_fetch_assoc($ffmszresultdetail);

$ffmszdetailshow = "Select * from " . config['tb_prefix'] . "pd_show where sz = $ffmsz AND cat != '' ORDER BY showid desc LIMIT 1";
...
$fffszdetail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$fffsz'";
$fffszresultdetail = mysqli_query($aVar, $fffszdetail);
$fffszccdetail = mysqli_fetch_assoc($fffszresultdetail);

$fffszdetailshow = "Select * from " . config['tb_prefix'] . "pd_show where sz = $fffsz AND cat != '' ORDER BY showid desc LIMIT 1";
...
$fmmszdetail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$fmmsz'";
$fmmszresultdetail = mysqli_query($aVar, $fmmszdetail);
$fmmszccdetail = mysqli_fetch_assoc($fmmszresultdetail);

$fmmszdetailshow = "Select * from " . config['tb_prefix'] . "pd_show where sz = $fmmsz AND cat != '' ORDER BY showid desc LIMIT 1";
...
$fmfszdetail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$fmfsz'";
$fmfszresultdetail = mysqli_query($aVar, $fmfszdetail);
$fmfszccdetail = mysqli_fetch_assoc($fmfszresultdetail);

$fmfszdetailshow = "Select * from " . config['tb_prefix'] . "pd_show where sz = $fmfsz AND cat != '' ORDER BY showid desc LIMIT 1";
...
$col4_1detail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$col4_1'";
$col4_1resultdetail = mysqli_query($aVar, $col4_1detail);
$col4_1ccdetail = mysqli_fetch_assoc($col4_1resultdetail);


$col4_1detail_show = "Select * from " . config['tb_prefix'] . "pd_show where sz = $col4_1 AND cat != '' ORDER BY showid desc LIMIT 1";
...
$col4_2detail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$col4_2'";
$col4_2resultdetail = mysqli_query($aVar, $col4_2detail);
$col4_2ccdetail = mysqli_fetch_assoc($col4_2resultdetail);

$col4_2detail_show = "Select * from " . config['tb_prefix'] . "pd_show where sz = $col4_2 AND cat != '' ORDER BY showid desc LIMIT 1";
...
$col4_3detail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$col4_3'";
$col4_3resultdetail = mysqli_query($aVar, $col4_3detail);
$col4_3ccdetail = mysqli_fetch_assoc($col4_3resultdetail);

$col4_3detail_show = "Select * from " . config['tb_prefix'] . "pd_show where sz = $col4_3 AND cat != '' ORDER BY showid desc LIMIT 1";
...
$col4_4detail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$col4_4'";
$col4_4resultdetail = mysqli_query($aVar, $col4_4detail);
$col4_4ccdetail = mysqli_fetch_assoc($col4_4resultdetail);

$col4_4detail_show = "Select * from " . config['tb_prefix'] . "pd_show where sz = $col4_4 AND cat != '' ORDER BY showid desc LIMIT 1";
...
$col4_5detail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$col4_5'";
$col4_5resultdetail = mysqli_query($aVar, $col4_5detail);
$col4_5ccdetail = mysqli_fetch_assoc($col4_5resultdetail);

$col4_5detail_show = "Select * from " . config['tb_prefix'] . "pd_show where sz = $col4_5 AND cat != '' ORDER BY showid desc LIMIT 1";
...
$col4_6detail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$col4_6'";
$col4_6resultdetail = mysqli_query($aVar, $col4_6detail);
$col4_6ccdetail = mysqli_fetch_assoc($col4_6resultdetail);

$col4_6detail_show = "Select * from " . config['tb_prefix'] . "pd_show where sz = $col4_6 AND cat != '' ORDER BY showid desc LIMIT 1";
...
$col4_7detail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$col4_7'";
$col4_7resultdetail = mysqli_query($aVar, $col4_7detail);
$col4_7ccdetail = mysqli_fetch_assoc($col4_7resultdetail);

$col4_7detail_show = "Select * from " . config['tb_prefix'] . "pd_show where sz = $col4_7 AND cat != '' ORDER BY showid desc LIMIT 1";
...
$col4_8detail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$col4_8'";
$col4_8resultdetail = mysqli_query($aVar, $col4_8detail);
$col4_8ccdetail = mysqli_fetch_assoc($col4_8resultdetail);

$col4_8detail_show = "Select * from " . config['tb_prefix'] . "pd_show where sz = $col4_8 AND cat != '' ORDER BY showid desc LIMIT 1";
...
$col4_9detail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$col4_9'";
$col4_9resultdetail = mysqli_query($aVar, $col4_9detail);
$col4_9ccdetail = mysqli_fetch_assoc($col4_9resultdetail);

$col4_9detail_show = "Select * from " . config['tb_prefix'] . "pd_show where sz = $col4_9 AND cat != '' ORDER BY showid desc LIMIT 1";
...
$col4_10detail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$col4_10'";
$col4_10resultdetail = mysqli_query($aVar, $col4_10detail);
$col4_10ccdetail = mysqli_fetch_assoc($col4_10resultdetail);

$col4_10detail_show = "Select * from " . config['tb_prefix'] . "pd_show where sz = $col4_10 AND cat != '' ORDER BY showid desc LIMIT 1";
...
$col4_11detail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$col4_11'";
$col4_11resultdetail = mysqli_query($aVar, $col4_11detail);
$col4_11ccdetail = mysqli_fetch_assoc($col4_11resultdetail);

$col4_11detail_show = "Select * from " . config['tb_prefix'] . "pd_show where sz = $col4_11 AND cat != '' ORDER BY showid desc LIMIT 1";
...
$col4_12detail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$col4_12'";
$col4_12resultdetail = mysqli_query($aVar, $col4_12detail);
$col4_12ccdetail = mysqli_fetch_assoc($col4_12resultdetail);

$col4_12detail_show = "Select * from " . config['tb_prefix'] . "pd_show where sz = $col4_12 AND cat != '' ORDER BY showid desc LIMIT 1";
...
$col4_13detail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$col4_13'";
$col4_13resultdetail = mysqli_query($aVar, $col4_13detail);
$col4_13ccdetail = mysqli_fetch_assoc($col4_13resultdetail);

$col4_13detail_show = "Select * from " . config['tb_prefix'] . "pd_show where sz = $col4_13 AND cat != '' ORDER BY showid desc LIMIT 1";
...
$col4_14detail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$col4_14'";
$col4_14resultdetail = mysqli_query($aVar, $col4_14detail);
$col4_14ccdetail = mysqli_fetch_assoc($col4_14resultdetail);

$col4_14detail_show = "Select * from " . config['tb_prefix'] . "pd_show where sz = $col4_14 AND cat != '' ORDER BY showid desc LIMIT 1";
...
$col4_15detail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$col4_15'";
$col4_15resultdetail = mysqli_query($aVar, $col4_15detail);
$col4_15ccdetail = mysqli_fetch_assoc($col4_15resultdetail);

$col4_15detail_show = "Select * from " . config['tb_prefix'] . "pd_show where sz = $col4_15 AND cat != '' ORDER BY showid desc LIMIT 1";
...
$col4_16detail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$col4_16'";
$col4_16resultdetail = mysqli_query($aVar, $col4_16detail);
$col4_16ccdetail = mysqli_fetch_assoc($col4_16resultdetail);

$col4_16detail_show = "Select * from " . config['tb_prefix'] . "pd_show where sz = $col4_16 AND cat != '' ORDER BY showid desc LIMIT 1";
...
$col5_1detail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$col5_1'";
$col5_1resultdetail = mysqli_query($aVar, $col5_1detail);
$col5_1ccdetail = mysqli_fetch_assoc($col5_1resultdetail);


$col5_1detail_show = "Select * from " . config['tb_prefix'] . "pd_show where sz = $col5_1 AND cat != '' ORDER BY showid desc LIMIT 1";
...
$col5_2detail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$col5_2'";
$col5_2resultdetail = mysqli_query($aVar, $col5_2detail);
$col5_2ccdetail = mysqli_fetch_assoc($col5_2resultdetail);


$col5_2detail_show = "Select * from " . config['tb_prefix'] . "pd_show where sz = $col5_2 AND cat != '' ORDER BY showid desc LIMIT 1";
...
$col5_3detail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$col5_3'";
$col5_3resultdetail = mysqli_query($aVar, $col5_3detail);
$col5_3ccdetail = mysqli_fetch_assoc($col5_3resultdetail);


$col5_3detail_show = "Select * from " . config['tb_prefix'] . "pd_show where sz = $col5_3 AND cat != '' ORDER BY showid desc LIMIT 1";
...
$col5_4detail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$col5_4'";
$col5_4resultdetail = mysqli_query($aVar, $col5_4detail);
$col5_4ccdetail = mysqli_fetch_assoc($col5_4resultdetail);


$col5_4detail_show = "Select * from " . config['tb_prefix'] . "pd_show where sz = $col5_4 AND cat != '' ORDER BY showid desc LIMIT 1";
...
$col5_5detail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$col5_5'";
$col5_5resultdetail = mysqli_query($aVar, $col5_5detail);
$col5_5ccdetail = mysqli_fetch_assoc($col5_5resultdetail);


$col5_5detail_show = "Select * from " . config['tb_prefix'] . "pd_show where sz = $col5_5 AND cat != '' ORDER BY showid desc LIMIT 1";
...
$col5_6detail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$col5_6'";
$col5_6resultdetail = mysqli_query($aVar, $col5_6detail);
$col5_6ccdetail = mysqli_fetch_assoc($col5_6resultdetail);


$col5_6detail_show = "Select * from " . config['tb_prefix'] . "pd_show where sz = $col5_6 AND cat != '' ORDER BY showid desc LIMIT 1";
...
$col5_7detail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$col5_7'";
$col5_7resultdetail = mysqli_query($aVar, $col5_7detail);
$col5_7ccdetail = mysqli_fetch_assoc($col5_7resultdetail);


$col5_7detail_show = "Select * from " . config['tb_prefix'] . "pd_show where sz = $col5_7 AND cat != '' ORDER BY showid desc LIMIT 1";
...
$col5_8detail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$col5_8'";
$col5_8resultdetail = mysqli_query($aVar, $col5_8detail);
$col5_8ccdetail = mysqli_fetch_assoc($col5_8resultdetail);


$col5_8detail_show = "Select * from " . config['tb_prefix'] . "pd_show where sz = $col5_8 AND cat != '' ORDER BY showid desc LIMIT 1";
...
$col5_9detail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$col5_9'";
$col5_9resultdetail = mysqli_query($aVar, $col5_9detail);
$col5_9ccdetail = mysqli_fetch_assoc($col5_9resultdetail);


$col5_9detail_show = "Select * from " . config['tb_prefix'] . "pd_show where sz = $col5_9 AND cat != '' ORDER BY showid desc LIMIT 1";
...
$col5_10detail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$col5_10'";
$col5_10resultdetail = mysqli_query($aVar, $col5_10detail);
$col5_10ccdetail = mysqli_fetch_assoc($col5_10resultdetail);


$col5_10detail_show = "Select * from " . config['tb_prefix'] . "pd_show where sz = $col5_10 AND cat != '' ORDER BY showid desc LIMIT 1";
...
$col5_11detail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$col5_11'";
$col5_11resultdetail = mysqli_query($aVar, $col5_11detail);
$col5_11ccdetail = mysqli_fetch_assoc($col5_11resultdetail);


$col5_11detail_show = "Select * from " . config['tb_prefix'] . "pd_show where sz = $col5_11 AND cat != '' ORDER BY showid desc LIMIT 1";
...
$col5_12detail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$col5_12'";
$col5_12resultdetail = mysqli_query($aVar, $col5_12detail);
$col5_12ccdetail = mysqli_fetch_assoc($col5_12resultdetail);


$col5_12detail_show = "Select * from " . config['tb_prefix'] . "pd_show where sz = $col5_12 AND cat != '' ORDER BY showid desc LIMIT 1";
...
$col5_13detail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$col5_13'";
$col5_13resultdetail = mysqli_query($aVar, $col5_13detail);
$col5_13ccdetail = mysqli_fetch_assoc($col5_13resultdetail);


$col5_13detail_show = "Select * from " . config['tb_prefix'] . "pd_show where sz = $col5_13 AND cat != '' ORDER BY showid desc LIMIT 1";
...
$col5_14detail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$col5_14'";
$col5_14resultdetail = mysqli_query($aVar, $col5_14detail);
$col5_14ccdetail = mysqli_fetch_assoc($col5_14resultdetail);


$col5_14detail_show = "Select * from " . config['tb_prefix'] . "pd_show where sz = $col5_14 AND cat != '' ORDER BY showid desc LIMIT 1";
...
$col5_15detail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$col5_15'";
$col5_15resultdetail = mysqli_query($aVar, $col5_15detail);
$col5_15ccdetail = mysqli_fetch_assoc($col5_15resultdetail);


$col5_15detail_show = "Select * from " . config['tb_prefix'] . "pd_show where sz = $col5_15 AND cat != '' ORDER BY showid desc LIMIT 1";
...
$col5_16detail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$col5_16'";
$col5_16resultdetail = mysqli_query($aVar, $col5_16detail);
$col5_16ccdetail = mysqli_fetch_assoc($col5_16resultdetail);


$col5_16detail_show = "Select * from " . config['tb_prefix'] . "pd_show where sz = $col5_16 AND cat != '' ORDER BY showid desc LIMIT 1";
...
$col5_17detail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$col5_17'";
$col5_17resultdetail = mysqli_query($aVar, $col5_17detail);
$col5_17ccdetail = mysqli_fetch_assoc($col5_17resultdetail);


$col5_17detail_show = "Select * from " . config['tb_prefix'] . "pd_show where sz = $col5_17 AND cat != '' ORDER BY showid desc LIMIT 1";
...
$col5_18detail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$col5_18'";
$col5_18resultdetail = mysqli_query($aVar, $col5_18detail);
$col5_18ccdetail = mysqli_fetch_assoc($col5_18resultdetail);


$col5_18detail_show = "Select * from " . config['tb_prefix'] . "pd_show where sz = $col5_18 AND cat != '' ORDER BY showid desc LIMIT 1";
...
$col5_19detail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$col5_19'";
$col5_19resultdetail = mysqli_query($aVar, $col5_19detail);
$col5_19ccdetail = mysqli_fetch_assoc($col5_19resultdetail);


$col5_19detail_show = "Select * from " . config['tb_prefix'] . "pd_show where sz = $col5_19 AND cat != '' ORDER BY showid desc LIMIT 1";
...
$col5_20detail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$col5_20'";
$col5_20resultdetail = mysqli_query($aVar, $col5_20detail);
$col5_20ccdetail = mysqli_fetch_assoc($col5_20resultdetail);


$col5_20detail_show = "Select * from " . config['tb_prefix'] . "pd_show where sz = $col5_20 AND cat != '' ORDER BY showid desc LIMIT 1";
...
$col5_21detail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$col5_21'";
$col5_21resultdetail = mysqli_query($aVar, $col5_21detail);
$col5_21ccdetail = mysqli_fetch_assoc($col5_21resultdetail);


$col5_21detail_show = "Select * from " . config['tb_prefix'] . "pd_show where sz = $col5_21 AND cat != '' ORDER BY showid desc LIMIT 1";
...
$col5_22detail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$col5_22'";
$col5_22resultdetail = mysqli_query($aVar, $col5_22detail);
$col5_22ccdetail = mysqli_fetch_assoc($col5_22resultdetail);


$col5_22detail_show = "Select * from " . config['tb_prefix'] . "pd_show where sz = $col5_22 AND cat != '' ORDER BY showid desc LIMIT 1";
...
$col5_23detail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$col5_23'";
$col5_23resultdetail = mysqli_query($aVar, $col5_23detail);
$col5_23ccdetail = mysqli_fetch_assoc($col5_23resultdetail);


$col5_23detail_show = "Select * from " . config['tb_prefix'] . "pd_show where sz = $col5_23 AND cat != '' ORDER BY showid desc LIMIT 1";
...
$col5_24detail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$col5_24'";
$col5_24resultdetail = mysqli_query($aVar, $col5_24detail);
$col5_24ccdetail = mysqli_fetch_assoc($col5_24resultdetail);


$col5_24detail_show = "Select * from " . config['tb_prefix'] . "pd_show where sz = $col5_24 AND cat != '' ORDER BY showid desc LIMIT 1";
...
$col5_25detail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$col5_25'";
$col5_25resultdetail = mysqli_query($aVar, $col5_25detail);
$col5_25ccdetail = mysqli_fetch_assoc($col5_25resultdetail);


$col5_25detail_show = "Select * from " . config['tb_prefix'] . "pd_show where sz = $col5_25 AND cat != '' ORDER BY showid desc LIMIT 1";
...
$col5_26detail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$col5_26'";
$col5_26resultdetail = mysqli_query($aVar, $col5_26detail);
$col5_26ccdetail = mysqli_fetch_assoc($col5_26resultdetail);


$col5_26detail_show = "Select * from " . config['tb_prefix'] . "pd_show where sz = $col5_26 AND cat != '' ORDER BY showid desc LIMIT 1";
...
$col5_27detail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$col5_27'";
$col5_27resultdetail = mysqli_query($aVar, $col5_27detail);
$col5_27ccdetail = mysqli_fetch_assoc($col5_27resultdetail);


$col5_27detail_show = "Select * from " . config['tb_prefix'] . "pd_show where sz = $col5_27 AND cat != '' ORDER BY showid desc LIMIT 1";
...
$col5_28detail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$col5_28'";
$col5_28resultdetail = mysqli_query($aVar, $col5_28detail);
$col5_28ccdetail = mysqli_fetch_assoc($col5_28resultdetail);


$col5_28detail_show = "Select * from " . config['tb_prefix'] . "pd_show where sz = $col5_28 AND cat != '' ORDER BY showid desc LIMIT 1";
...
$col5_29detail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$col5_29'";
$col5_29resultdetail = mysqli_query($aVar, $col5_29detail);
$col5_29ccdetail = mysqli_fetch_assoc($col5_29resultdetail);


$col5_29detail_show = "Select * from " . config['tb_prefix'] . "pd_show where sz = $col5_29 AND cat != '' ORDER BY showid desc LIMIT 1";
...
$col5_30detail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$col5_30'";
$col5_30resultdetail = mysqli_query($aVar, $col5_30detail);
$col5_30ccdetail = mysqli_fetch_assoc($col5_30resultdetail);


$col5_30detail_show = "Select * from " . config['tb_prefix'] . "pd_show where sz = $col5_30 AND cat != '' ORDER BY showid desc LIMIT 1";
...
$col5_31detail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$col5_31'";
$col5_31resultdetail = mysqli_query($aVar, $col5_31detail);
$col5_31ccdetail = mysqli_fetch_assoc($col5_31resultdetail);


$col5_31detail_show = "Select * from " . config['tb_prefix'] . "pd_show where sz = $col5_31 AND cat != '' ORDER BY showid desc LIMIT 1";
...
$col5_32detail = "SELECT * from " . config['tb_prefix'] . "pd_entries WHERE reg1='$col5_32'";
$col5_32resultdetail = mysqli_query($aVar, $col5_32detail);
$col5_32ccdetail = mysqli_fetch_assoc($col5_32resultdetail);


$col5_32detail_show = "Select * from " . config['tb_prefix'] . "pd_show where sz = $col5_32 AND cat != '' ORDER BY showid desc LIMIT 1";
